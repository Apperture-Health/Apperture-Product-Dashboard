      ...
      {!hasAnyFilter(filters)
        ...
        : (
          <>
            ...
            />
            {subtab === "categories" ? (
              ready("reportedOutcomeCategories") ? (
                <TwoCol>
            ...
            {subtab === "types" ? (
              ready("outcomeTypeCategoryHeatmap")
                ? <ChartTile title="Outcome Type × Category (Unique Trials)" figure={heatmapFigure(toRecs(pageData?.outcomeTypeCategoryHeatmap), "outcome_category", "outcome_type", "trial_count")} />
                : <ChartSkeleton />
            ) : null}
            {subtab === "top" ? (
              ready("reportedOutcomeCategories") ? (
